  ...
  return (
    <Fragment>
      <thead className="text-indigo-700">
        <tr>
        <th className="px-4 py-2 border text-indigo-700">Transaction Id</th>
  ...
  return (
    <Fragment>
      ...
      <td className="hover:bg-gray-200 p-2 text-center border">
        ...
        <td className=" hover:bg-gray-200 p-2 flex flex-col space-y-1 border">
    ...
    <Fragment>
      <div className="flex flex-col w-full my-4 md:my-0 md:w-9/12 md:px-8">
        <div className="border">
          <div className="py-4 px-4 my_orders_head font-bold border-t-8 border-indigo-700">
           My  Orders
          </div>
          <hr />
