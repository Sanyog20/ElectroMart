    ...
    <Fragment>
      <div className="flex flex-col w-full my-4 md:my-0 md:w-9/12 md:px-8">
        <div className="shadow-lg border">
          <div className="py-4 px-4 text-lg font-semibold border-t-4 border-indigo-600">
          ...
          <div className="py-4 px-4 md:px-8 lg:px-16 flex flex-col space-y-4">
            ...
            <div
              ...
              className="w-full text-center cursor-pointer px-4 py-2 text-gray-100 bg-indigo-700"
            >
              Update Information
            </div>
          </div>
