        ...
        <div className="grid grid-cols-2 md:grid-cols-12">
            ...
            <div className="relative">
              ...
              <div className="absolute inset-0 flex justify-between items-center mb-4">
                <svg
                  ...
                  className="  flex justify-center  w-12 h-12 text-white-700  cursor-pointer hover:text-blue-100 "
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="col-span-2 mt-8 md:mt-0 md:col-span-4 md:ml-6 lg:ml-12">
            <div className="flex flex-col leading-8">
              <div className="text-2xl  p_name_single tracking-wider">{sProduct.pName}</div>
              <div>
                Category : {sProduct.pCategory.cName}
              </div>
              <div className="flex justify-between items-center">
                <span className="text-xl  p_price_single tracking-wider text-black-700">
                &#8377;{sProduct.pPrice}.00
                </span>
                <span>
                  <svg
                    ...
                    } w-5 h-5 md:w-6 md:h-6 cursor-pointer text-red-600`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="my-4 md:my-6">
              ...
              {sProduct.pQuantity !== 0 ? (
                <Fragment>
                  ...
                  layoutData.inCart.includes(sProduct._id) === true ? (
                    ...
                    <div
                      ...
                      className={`px-4 py-2 mt-3 text-black font-bold text-center cursor-pointer uppercase`}
                    >
                      Add to cart
                    </div>
                  )}
                ...
                <Fragment>
                  ...
                  layoutData.inCart.includes(sProduct._id) === true ? (
                    <div
                      style={{ background: "#4D5382 " }}
                      className={`px-4 py-2 mt-2 text-white text-center cursor-not-allowed uppercase opacity-100`}
                    >
                      In cart
                    </div>
                  ) : (
