  ...
  if (loading) {
    return (
      <div className="my-32 text-2xl text-center">
        You haven't saved any product in wishlist
      </div>
    );
  }
  return (
    <Fragment>
      <div className="grid grid-cols-2 md:grid-cols-1 border-none">
        {products.length > 0 ? (
            ...
            return (
              ...
              >
                ...
                <div className="md:w-1/2 md:flex md:items-center md:justify-around">
                  ...
                  {product.pQuantity > 0 ? (
                    <div className="text-green-500 my-1 md:my-0 wish_list_stock_info">In Stock</div>
                  ) : (
                    <div className="text-red-500 my-1 md:my-0 wish_list_stock_info">Out Stock</div>
                  )}

                  <div
                    style={{ background: "#fd6969" }}
                    onClick={(e) => history.push(`/products/${product._id}`)}
          ...
          <div className="wish_list_no_p_f">No product found in wishList</div>
        )}
      </div>
    </Fragment>
  );
  ...
  return (
    <Fragment>
      <section className="mx-4 mt-20 md:mx-12 md:mt-32 lg:mt-24">
        <div className="wish_list_head mx-2 mb-6 "> My Wishlist</div>
        {/* Product List */}
        <Product />
      </section>
    </Fragment>
