...
const Navber = (props) => {
  ...
  return (
    <Fragment>
      {/* Navber Section */}
      <nav className="fixed top-0 w-full z-20  bg-dark  navbar">
        <div className="md:mx-12 my-3 grid grid-cols-4 lg:grid-cols-3">
          <div className="hidden lg:block col-span-1 flex text-white mt-2 ">
            <span
          ...
          <div className="col-span-2 lg:hidden flex justify-items-stretch	 items-center">
            <svg
              ...
              className="col-span-1 lg:hidden w-8 h-8 cursor-pointer text-white"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
