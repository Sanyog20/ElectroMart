...
const AdminSidebar = (props) => {
  ...
  return (
    <Fragment>
      <div
        id="sidebar"
        className="hidden md:block sticky top-0 left-0 h-screen md:w-3/12 lg:w-2/12  bg-white text-gray-600"
      >
        <div
        ...
        <div
          ...
          className={`${
            location.pathname === "/admin/dashboard/categories"
              ? "border-r-4 border-purple-800 bg-gray-100"
              : ""
          } hover:bg-gray-200 cursor-pointer flex flex-col items-center justify-center py-6`}
        >
          <span>
            <svg
              className="w-8 h-8 text-purple hover:text-purple"
              fill="none"
              stroke="#4937D2"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div
          ...
          className={`${
            location.pathname === "/admin/dashboard/orders"
              ? "border-r-1 border-gray-800 bg-gray-100"
              : ""
          } hover:bg-gray-200 cursor-pointer flex flex-col items-center justify-center py-6`}
        >
          <span>
