    ...
    <Fragment>
      <tr>
        ...
        <td className="p-2 text-center border">
          <img
            className="w-12 h-12 object-cover object-center border"
        ...
        <td className="p-2 flex items-center justify-center border">
          <span
            onClick={(e) => editProduct(product._id, product, true)}
            className="cursor-pointer hover:bg-gray-200 rounded-lg p-2 mx-1 border"
          >
            <svg
